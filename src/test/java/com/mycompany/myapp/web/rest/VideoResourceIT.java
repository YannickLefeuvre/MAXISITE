...
class VideoResourceIT {
    ...
    public static Video createEntity(EntityManager em) {
        Video video = new Video().nom(DEFAULT_NOM).url(DEFAULT_URL);
        return video;
    }
    ...
    public static Video createUpdatedEntity(EntityManager em) {
        Video video = new Video().nom(UPDATED_NOM).url(UPDATED_URL);
        return video;
    }
    ...
    void putNewVideo() throws Exception {
        ...
        updatedVideo.nom(UPDATED_NOM).url(UPDATED_URL);
    ...
    void fullUpdateVideoWithPatch() throws Exception {
        ...
        partialUpdatedVideo.nom(UPDATED_NOM).url(UPDATED_URL);
