...
class ApplicationUserResourceIT {
    ...
    private static final byte[] DEFAULT_PHOTOPRINCIPAL = TestUtil.createByteArray(1, "0");
    private static final byte[] UPDATED_PHOTOPRINCIPAL = TestUtil.createByteArray(1, "1");
    private static final String DEFAULT_PHOTOPRINCIPAL_CONTENT_TYPE = "image/jpg";
    private static final String UPDATED_PHOTOPRINCIPAL_CONTENT_TYPE = "image/png";
    ...
    public static ApplicationUser createEntity(EntityManager em) {
        ApplicationUser applicationUser = new ApplicationUser()
            .photoprincipal(DEFAULT_PHOTOPRINCIPAL)
            .photoprincipalContentType(DEFAULT_PHOTOPRINCIPAL_CONTENT_TYPE);
    ...
    public static ApplicationUser createUpdatedEntity(EntityManager em) {
        ApplicationUser applicationUser = new ApplicationUser()
            .photoprincipal(UPDATED_PHOTOPRINCIPAL)
            .photoprincipalContentType(UPDATED_PHOTOPRINCIPAL_CONTENT_TYPE);
        return applicationUser;
    }
    ...
    void createApplicationUser() throws Exception {
        ...
        assertThat(testApplicationUser.getPhotoprincipal()).isEqualTo(DEFAULT_PHOTOPRINCIPAL);
        assertThat(testApplicationUser.getPhotoprincipalContentType()).isEqualTo(DEFAULT_PHOTOPRINCIPAL_CONTENT_TYPE);
    }
    ...
    void getAllApplicationUsers() throws Exception {
        ...
        restApplicationUserMockMvc
            ...
            .andExpect(jsonPath("$.[*].photoprincipalContentType").value(hasItem(DEFAULT_PHOTOPRINCIPAL_CONTENT_TYPE)))
            .andExpect(jsonPath("$.[*].photoprincipal").value(hasItem(Base64Utils.encodeToString(DEFAULT_PHOTOPRINCIPAL))));
    }
    ...
    void getApplicationUser() throws Exception {
        ...
        restApplicationUserMockMvc
            ...
            .andExpect(jsonPath("$.photoprincipalContentType").value(DEFAULT_PHOTOPRINCIPAL_CONTENT_TYPE))
            .andExpect(jsonPath("$.photoprincipal").value(Base64Utils.encodeToString(DEFAULT_PHOTOPRINCIPAL)));
    }
    ...
    void putNewApplicationUser() throws Exception {
        ...
        updatedApplicationUser.photoprincipal(UPDATED_PHOTOPRINCIPAL).photoprincipalContentType(UPDATED_PHOTOPRINCIPAL_CONTENT_TYPE);
        ...
        ApplicationUser testApplicationUser = applicationUserList.get(applicationUserList.size() - 1);
        assertThat(testApplicationUser.getPhotoprincipal()).isEqualTo(UPDATED_PHOTOPRINCIPAL);
        assertThat(testApplicationUser.getPhotoprincipalContentType()).isEqualTo(UPDATED_PHOTOPRINCIPAL_CONTENT_TYPE);
    }
    ...
    void fullUpdateApplicationUserWithPatch() throws Exception {
        ...
        partialUpdatedApplicationUser.photoprincipal(UPDATED_PHOTOPRINCIPAL).photoprincipalContentType(UPDATED_PHOTOPRINCIPAL_CONTENT_TYPE);
