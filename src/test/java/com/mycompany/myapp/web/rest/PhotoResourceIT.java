...
class PhotoResourceIT {
    ...
    void createPhoto() throws Exception {
        ...
        assertThat(testPhoto.getNom()).isEqualTo(DEFAULT_NOM);
        assertThat(testPhoto.getImages()).isEqualTo(DEFAULT_IMAGES);
        assertThat(testPhoto.getImagesContentType()).isEqualTo(DEFAULT_IMAGES_CONTENT_TYPE);
    ...
    void putNewPhoto() throws Exception {
        ...
        Photo testPhoto = photoList.get(photoList.size() - 1);
        assertThat(testPhoto.getNom()).isEqualTo(UPDATED_NOM);
        assertThat(testPhoto.getImages()).isEqualTo(UPDATED_IMAGES);
        assertThat(testPhoto.getImagesContentType()).isEqualTo(UPDATED_IMAGES_CONTENT_TYPE);
    ...
    void partialUpdatePhotoWithPatch() throws Exception {
        ...
        partialUpdatedPhoto.nom(UPDATED_NOM).description(UPDATED_DESCRIPTION);
