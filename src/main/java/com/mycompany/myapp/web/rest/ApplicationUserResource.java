    ...
    public ResponseEntity<ApplicationUser> partialUpdateApplicationUser(
        ...
        Optional<ApplicationUser> result = applicationUserRepository
            ...
            .map(existingApplicationUser -> {
                if (applicationUser.getPhotoprincipal() != null) {
                    existingApplicationUser.setPhotoprincipal(applicationUser.getPhotoprincipal());
                }
                if (applicationUser.getPhotoprincipalContentType() != null) {
                    existingApplicationUser.setPhotoprincipalContentType(applicationUser.getPhotoprincipalContentType());
                }
